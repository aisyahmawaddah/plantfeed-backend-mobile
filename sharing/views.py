...
from sharing.serializers import FeedSerializerDetails, PostCommentSerializer, ReplyCommentSerializer
from .models import Feed, Comment, GroupTimeline, GroupTimelineComment,Likes, ReplyComment
...
class FeedDetailView(RetrieveAPIView):
    ...
    serializer_class = FeedSerializerDetails
