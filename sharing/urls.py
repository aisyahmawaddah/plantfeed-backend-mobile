...
urlpatterns = [
    ...
    path('users/feed-details/<int:pk>', FeedDetailView.as_view(), name="feed-detail"),
    path('users/feeds/<int:feed_id>/comments/', api.get_comments_by_feed, name='get_comments_by_feed'),
    path('users/add-comments/', api.postComment, name ="create-comment"),
    path('users/reply-comments/', api.replyComment, name ="reply-comment"),
    path('users/reply-comments/comment/<int:comment_id>/', ReplyCommentListByCommentID.as_view(),name= "view-reply")
