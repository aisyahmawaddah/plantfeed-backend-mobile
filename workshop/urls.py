...
urlpatterns = [
    ...
    path('workshop-list', views.WorkshopListAPIView.as_view(), name='workshop-list'),
    path('bookings/<int:Participant_id>/', views.BookingListAPIView.as_view(), name='booking-list'),
    path('bookings/workshop/', views.WorkshopBookingCreateAPIView.as_view(), name='booking-list'),
    path('bookings/cancel/', views.CancelBookingView.as_view(), name='cancel_booking'),
    path('workshop-timeline/<int:workshop_id>/', views.workshop_sharing, name='workshop_sharing'),
